...
public class BookCricketGame
{
   public static void main(String[] args)
   {
     ...
     while(true)
     {
           int p1_score=0,p2_score=0,points,p1_round=0,p2_round=0,pg;
           ...
           p1_score+=points;
             ...
             System.out.println("Page Number "+pg+"\t\t\tPoint : "+points+"\t\t\tScore : "+p1_score);
             if(points==0)
             {
           ...
           points=pg%7;
           p2_score+=points;
          System.out.println("Page Number "+pg+"\t\t\tPoint : "+points+"\t\t\tScore : "+p2_score+"\t\t\tRounds Left : "+(--p2_round));
